...
def main() -> None:
    ...
    val_data_path = "/mlx/users/fanliwen.2333/playground/code/CS60004-LAB3-RL/data/splits/raw_test_low_repeat_accuracy_v2_tmp.jsonl"
    output_path = ""
    output_path = Path("data/benchmark/v2_tmp_filter.jsonl")
